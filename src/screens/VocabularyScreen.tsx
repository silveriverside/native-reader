...
import { getByPage, updateStatus } from '@/services/vocabularyService';
...
export default function VocabularyScreen() {
  ...
  const route = useRoute<RouteProp<RootStackParamList, 'Vocabulary'>>();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>本页词汇</Text>
        <View style={{ width: 40 }} />
      </View>
